...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- gml:identification -->
    <xsl:template match="sml:identifier/sml:Term[ @definition='http://mmisw.org/ont/ioos/definition/shortName' and not(./sml:value) ]" />
    <xsl:template match="sml:identifier/sml:Term[ @definition='http://mmisw.org/ont/ioos/definition/manufacturerName' and not(./sml:value) ]" />
    <xsl:template match="sml:identifier/sml:Term[ @definition='http://mmisw.org/ont/ioos/definition/longName' and not(./sml:value) ]" />
    <xsl:template match="sml:identifier/sml:Term[ @definition='http://mmisw.org/ont/ioos/definition/modelNumber' and not(./sml:value) ]" />
    <xsl:template match="sml:identifier/sml:Term[ @definition='http://mmisw.org/ont/ioos/definition/serialNumber' and not(./sml:value) ]" />
    ...
    <!-- sml:contacts -->
    <xsl:template match="sml:contacts[ not(.//sml:ContactList/sml:contact[@xlink:arcrole='http://mmisw.org/ont/ioos/definition/manufacturerName']/gmd:CI_ResponsibleParty/gmd:organizationName) and not(./sml:ContactList/sml:contact[@xlink:arcrole='http://mmisw.org/ont/ioos/definition/manufacturerName']/gmd:CI_ResponsibleParty/gmd:contactInfo) ]"/>
    <xsl:template match="sml:contacts[descendant::sml:ContactList/sml:contact[@xlink:arcrole='http://mmisw.org/ont/ioos/definition/manufacturerName']/gmd:deliveryPoint/gco:CharacterString/text() = ', ' ]"/>
    <xsl:template match="sml:contacts[ not(.//sml:ContactList/sml:contact[@xlink:arcrole='http://inspire.ec.europa.eu/metadata-codelist/ResponsiblePartyRole/owner']/gmd:CI_ResponsibleParty/gmd:organizationName) and not(./sml:ContactList/sml:contact[@xlink:arcrole='http://inspire.ec.europa.eu/metadata-codelist/ResponsiblePartyRole/owner']/gmd:CI_ResponsibleParty/gmd:contactInfo) ]"/>
    <xsl:template match="sml:contacts[ not(.//sml:ContactList/sml:contact[@xlink:arcrole='http://inspire.ec.europa.eu/metadata-codelist/ResponsiblePartyRole/pointOfContact']/gmd:CI_ResponsibleParty/gmd:organizationName) and not(./sml:ContactList/sml:contact[@xlink:arcrole='http://inspire.ec.europa.eu/metadata-codelist/ResponsiblePartyRole/pointOfContact']/gmd:CI_ResponsibleParty/gmd:contactInfo) ]"/>
