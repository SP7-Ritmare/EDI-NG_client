...
if (NEW_VERSION) {
    // FIXME: not working yet: using old version
    class BoundingBox {
...
//Make sure your bounding box interaction variable is global
        ...
        static drawBoxOnMap(map, source, extent, epsg) {
        ...
        static render() {
            ...
            $("control_boundingbox").each(function () {
                ...
                if (true || item.CRSItem) {
                    ...
                    */
                    const PanDragControl = function (opt_options) {
                        ...
                        var handleRotateNorth = function (e) {
                            ...
                            if (button.hasClass("mode-draw")) {
                                this_.getMap().removeInteraction(BoundingBox.boundingBox);
                                ...
                                this_.getMap().addInteraction(BoundingBox.boundingBox);
...
//Place this after your map is instantiated
                    BoundingBox.boundingBox = new ol.interaction.DragBox({
                    ...
                    if (item.isFixed == "false") {
                        ...
                        // map.addInteraction(BoundingBox.boundingBox);
                    }

                    // map.removeInteraction(boundingBox);

                    BoundingBox.boundingBox.on('boxend', function (e) {
                        var epsg = "4326"; // $("#" + item.CRSItem + " option:selected").text();
                        var box = BoundingBox.boundingBox.getGeometry().getExtent();
                        ...
                        */
                        // map.removeInteraction(BoundingBox.boundingBox);
                    })
