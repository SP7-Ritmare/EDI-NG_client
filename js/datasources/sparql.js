...
var SPARQL = (function (url, endpointType) {
    ...
    const sparqlEndpointAdapter = new SparqlEndpointAdapter(virtuosoUrl, endpointType)
    ...
    async function specificQuery(query, callback, errorCallback, language) {
        ...
        */
        ...
        console.log('endpoint type', endpointType.parameters.contentType.json)
        const jqXHR = sparqlEndpointAdapter.query(newQuery, callback, errorCallback)
        return jqXHR
        /*        var jqXHR = $.ajax({
                    url: virtuosoUrl,
                    type: endpointType.parameters.method,
                    accept: endpointType.parameters.contentType.json,
                    dataType: "json",
                    crossDomain: true,
                    /!*
                    data: {
    ...
    function query(uri, callback, errorCallback, language) {
        ...
        const jqXHR = sparqlEndpointAdapter.query(sparqlQuery, callback, errorCallback)
        return jqXHR
/*
        var jqXHR = $.ajax({
            url: virtuosoUrl,
